...
public class UnaccentInit extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -462769184;
     ...
     */
    public UnaccentInit() {
        super("unaccent_init", Public.PUBLIC, DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""));
     ...
     */
    public UnaccentInit set__1(Field<Object> field) {
        setField(_1, field);
        return this;
    }
}
