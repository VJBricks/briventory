...
public class ColorInfoRecord extends UpdatableRecordImpl<ColorInfoRecord> {

    private static final long serialVersionUID = -312523940;
     ...
     */
    @Column(name = "id_color_source", nullable = false)
    @NotNull
    @Nonnull
     ...
     */
    @Column(name = "id_rgba", nullable = false)
    @NotNull
    @Nonnull
